    ...
    static func mock(theme: Theme) -> SelectionGroupExamples {
        return SelectionGroupExamples(titles: [
            ...
            "Multi-Select, Selected"
                ...
                SelectionGroupExample.mock(theme: theme, tag: 1, numberOfOptions: 3, singleStyle: .allChoices, selectedIndex: 0),
                SelectionGroupExample.mock(theme: theme, tag: 2, numberOfOptions: 3, singleStyle: .menu, selectedIndex: nil),
                SelectionGroupExample.mock(theme: theme, tag: 3, numberOfOptions: 3, singleStyle: .menu, selectedIndex: 0),
                SelectionGroupExample.mock(theme: theme, tag: 4, numberOfOptions: 10, singleStyle: .topChoices(false, SELECTION_GROUP_EXPAND_TITLE), selectedIndex: nil),
                SelectionGroupExample.mock(theme: theme, tag: 5, numberOfOptions: 10, singleStyle: .topChoices(true, SELECTION_GROUP_EXPAND_TITLE), selectedIndex: nil),
                SelectionGroupExample.mock(theme: theme, tag: 6, numberOfOptions: 3, selectedIndices: []),
                SelectionGroupExample.mock(theme: theme, tag: 7, numberOfOptions: 3, selectedIndices: [0, 1])
        ])
    }
}
